 ...
 * com.cg.oam.exception.CustomerNotFoundException; import
 * com.cg.oam.repository.CustomerRepository;
 * 
 * @SpringBootTest class CustomerServiceTest {
 * 
 * @InjectMocks CustomerServiceImpl customerServiceImpl = new
 * CustomerServiceImpl();
 * 
 * @Mock CustomerRepository customerRepository;
 * 
 * @Test void testGetCustomerById() {
 * 
 ...
 * 
 * @Test void testGetCustomerByIdException() {
 * 
 * when(customerRepository.findById(111)).thenThrow(CustomerNotFoundException.
 * class);
 * 
 * assertThrows(CustomerNotFoundException.class, () ->
 * customerServiceImpl.getCustomerById(111)); }
 * 
 ...
 * customer.setMobileNo("5678904321"); customer.setAddress("Karnataka");
 * 
 * Customer customer2 = new Customer(); customer2.setCustomerId(112);
 * customer2.setCustomerName("gayathri");
 * customer2.setEmail("gayathri@gmail.com");
 * customer2.setMobileNo("5678994321"); customer2.setAddress("vijayawada");
 * 
 * Customer customer3 = new Customer(); customer3.setCustomerId(113);
 * customer3.setCustomerName("kavana"); customer3.setEmail("kavana@gmail.com");
 * customer3.setMobileNo("5678904321"); customer3.setAddress("Karnataka");
 * 
 * List<Customer> customerList = new ArrayList<>(); customerList.add(customer3);
 * customerList.add(customer2); customerList.add(customer);
 * 
