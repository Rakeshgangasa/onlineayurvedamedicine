...
public class MedicineServiceTest {
   ...
   @Test
    ...
    /*
     * @Test public void testDeleteMedicine() {
     *
     * Medicine medicine = new Medicine(); medicine.setMedicineId(101);
     * medicine.setMedicineName("Ashwagandha"); medicine.setMedicineCost(595);
     * medicine.setMfd(LocalDate.of(2020, 10, 10));
     * medicine.setExpiryDate(LocalDate.of(2021, 10, 10));
     *
     * Optional<Medicine> optionalMedicine = Optional.of(medicine);
     ...
     *
     * medicineServiceImpl.deleteMedicineById(101);
     *
